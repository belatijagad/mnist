...
class TensorboardWriter:
    def __init__(self, log_dir, logger, enabled: bool):
        ...
        if enabled:
            ...
            if not succeeded:
                logger.warning('Warning: visualization (Tensorboard) is configured to use, but currently not installing on '
        ...
        self.tag_mode_exceptions = {'add_histogram', 'add_embeddings'}
